...
create index if not exists license_accesses_license_id_idx
  on public.license_accesses (license_id);

create index if not exists order_reversals_order_id_idx
  on public.order_reversals (order_id);
